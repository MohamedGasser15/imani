...
abstract class AppLocalizations {
  ...
  /// No description provided for @locateQibla.
  ///
  /// In en, this message translates to:
  /// **'Locate Qibla'**
  String get locateQibla;

  /// No description provided for @findNearestMosque.
  ///
  /// In en, this message translates to:
  /// **'Find nearest Mosque'**
  String get findNearestMosque;
  ...
  /// No description provided for @completeDailyActivity.
  ///
  /// In en, this message translates to:
  /// **'Complete the daily activity checklist'**
  String get completeDailyActivity;
  ...
  /// No description provided for @ashr.
  ///
  /// In en, this message translates to:
  /// **'Ashr'**
  String get ashr;
